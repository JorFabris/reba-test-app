...
export const DATA: IProducts[] = [
  ...
  },
  {
    ...
    descripcion:
      'El Xiaomi 12S Ultra lidera la nueva serie Xiaomi 12S con cámaras optimizadas por Leica. El Xiaomi 12S Ultra cuenta con una pantalla AMOLED de 6.73 pulgadas a resolución QHD+ y tasa de refresco de 120Hz y está potenciado por un procesador Snapdragon 8+ Gen 1 con hasta 12GB de RAM y 512GB de almacenamiento interno. La cámara del Xiaomi 12S Ultra cuenta con un sensor principal de 50.3MP, un sensor de 48MP del tipo telefoto periscópico, una cámara ultrawide de 48MP y un sensor Time of Flight 3D para información de profundidad, con óptica Leica, zoom óptico 5x y OIS. La cámara selfie del Xiaomi 12S Ultra es de 32MP y completa sus características con una batería de 4860 mAh de carga rápida e inalámbrica, parlantes stereo, resistencia al polvo y agua, y corre Android 12.',
    img: 'https://iili.io/PULlMG.webp',
    price: 1030,
    capacity: 256,
    rate: 4.3,
    reviews: 566,
  },
  {
    ...
    descripcion:
      'El Motorola Edge 30 Pro es el nuevo flagship de Motorola. Con una pantalla OLED FHD+ de 6.7 pulgadas y refresco de 144Hz, el Edge 30 Pro está potenciado por un procesador Snapdragon 8 Gen 1 acompañado de 8GB o 12GB de RAM con hasta 512GB de almacenamiento interno. El Moto Edge 30 Pro tiene tres cámaras dorsales, siendo dos de ellas de 50MP, wide y ultrawide, asistidas por un sensor de profundidad de 2MP, y una cámara frontal de 60MP. Completando las características del Motorola Edge 30 Pro encontramos una batería de 4800 mAh de carga rápida tanto por cable como inalámbrica, parlantes stereo, resistencia a salpicaduras y corre Android 12.',
    img: 'https://iili.io/PUsVhg.jpgg',
    price: 589,
    capacity: 256,
    rate: 3.7,
    reviews: 950,
  ...
  },
  {
    ...
    descripcion:
      'El Google Pixel 6 Pro es el smartphone mas poderoso de la serie Pixel 6. Con el procesador Tensor diseñado por Google, el Pixel 6 Pro cuenta con una pantalla OLED LTPO a resolución QHD+ y tasa de refresco variable 120Hz. Al Tensor lo acompañan 12GB de RAM combinables con 128GB, 256GB o 512GB de almacenamiento. La cámara dorsal cuenta con tres lentes, siendo el principal uno de 50MP seguido de un ultrawide de 12MP y un telefoto de 48MP, con OIS, zoom óptico 4x y zoom combinado de hasta 20x, mientras que la cámara selfie es de 11.1MP. Una batería de 5003 mAh alimenta al Pixel 6 Pro y cuenta con carga rápida de 30W e inalámbrica de 23W, completando sus características con parlantes stereo, lector de huellas bajo la pantalla, resistencia al agua IP68, y Android 12.',
    img: 'https://iili.io/PUshCJ.jpg',
    price: 649,
    capacity: 256,
    rate: 4.9,
    reviews: 768,
